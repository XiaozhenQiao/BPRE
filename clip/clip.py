...
def _download(url: str, root: str):
    ...
    if os.path.isfile(local_model_path):
        ...
        raise RuntimeError(f"Model file {local_model_path} does not exist in the local directory")
...
def load(name: str, device: Union[str, torch.device] = "cuda" if torch.cuda.is_available() else "cpu", jit: bool = False, download_root: str = None):
    ...
    """
    if name in _MODELS:
        model_path = _download(_MODELS[name], download_root or "/data/zhaozy/qiaoxiaozhen/checkpoints")
